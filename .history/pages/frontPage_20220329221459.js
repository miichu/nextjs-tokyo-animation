...
export default function FrontPage() {
  ...
  const randomText: string = "We invent, design, and build digital products that are good for" + 
 "people and business."
  const descriptionText = !expandView? "We invent, design, and build digital products that are good for
  people and business.": "By My Thao Nguyen" ;
  return (
    <Page>
      <Container>
        {expandView && (
